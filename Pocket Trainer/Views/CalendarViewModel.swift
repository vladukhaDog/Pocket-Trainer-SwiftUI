...
class CalendarViewModel: ObservableObject {
     ...
     */
    func add(exerciseID: Int, date: Date, weights: [Int], repsNumber: [Int], comment: String = ""){
        db.addExerciseToDB(exerciseID: exerciseID, date: date, weights: weights, repsNumber: repsNumber, comment: comment)
