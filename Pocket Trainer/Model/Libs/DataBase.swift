...
class DataBase{
    ...
    private lazy var persistentContainer: NSPersistentContainer = {
        ...
        let container = NSPersistentContainer(name: "Pocket_Trainer")
...
//ExerciseID: exercisesFiltered[indexPath.row].ExerciseId, date: date, Weights: [], RepsNumber: []
    func addExerciseToDB(exerciseID: Int, date: Date, weights: [Int], repsNumber: [Int], comment: String){
        
        let exerciseToSave = SavedExercise(context: viewContext)
        //exerciseToSave = exercise
        //print(exerciseToSave)
        exerciseToSave.comment = comment
